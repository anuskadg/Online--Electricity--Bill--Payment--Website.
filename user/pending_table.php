  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="paid_table.php">Back</a>
        </li>
        <li class="nav-item">
    ...
    <table class="table table-bordered table-warning border-warning">
      ...
      <?php
            ...
            $name=NULL;
            $amt=NULL;
            $sql="select * from `bills` where `cid`='$cid' and `status`='pending'";
            ...
            <td>'.$status.'</td>
            <td>
            <a class="btn btn-success" href="payment_form.php? payid='.$id.'" role="button">Pay</a>
         </td>
          </tr>';
          $no ++;
        }
